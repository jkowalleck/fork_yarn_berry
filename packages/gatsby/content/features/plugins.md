...
- [**yarn-plugin-cyclonedx**](https://github.com/CycloneDX/cyclonedx-node-yarn) by [**OWASP CycloneDX**](https://github.com/CycloneDX) -Create CycloneDX Software Bill of Materials (SBOM) from Node.js Yarn projects.
